...
윈도우 자동 타일링
     ↓
ctrl+alt+방향키 (포커스 이동)
ctrl+alt+shift+방향키 (이동)
     ↓
워크스페이스 전환 (ctrl+alt+1-9)
```
...
| 단계 | 명령 | 설명 |
|------|------|------|
| 포커스 | `ctrl+alt+방향키` | 윈도우 간 이동 |
| 이동 | `ctrl+alt+shift+방향키` | 윈도우 위치 변경 |
| 워크스페이스 | `ctrl+alt+1-9` | 워크스페이스 전환 |
| 앱 실행 | `ctrl+alt+/` | 앱 러너 |
...
| 도구 | 관계 |
|------|------|
| tmux | Aerospace 안에서 tmux 사용 가능 |
| skhd | 키바인딩 보조 도구 |
| Ghostty | 타일링과 함께 터미널 사용 |
